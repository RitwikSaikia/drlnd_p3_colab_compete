...
def plot_scores(scores, ax=None, window_size=100, solved_score=None):
    ...
    if solved_score is not None:
        ...
        if len(solved_index) > 0:
            ...
            ax.plot(solved_index, solved_value, 'go-', markersize=MARKER_SIZE, color=RED,
    ...
    ax.plot(best_index, best_value, 'go-', markersize=MARKER_SIZE, color=YELLOW,
...
if __name__ == '__main__':
    ...
    scores = np.loadtxt("checkpoints/Tennis/scores.tsv")
    plot_scores(scores, solved_score=0.5)
